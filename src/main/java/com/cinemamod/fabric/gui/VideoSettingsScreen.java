...
public class VideoSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        CheckboxWidget muteCheckbox = CheckboxWidget.builder(Text.of("Mute video while alt-tabbed"), client.textRenderer)
                ...
                .build();
        addDrawableChild(muteCheckbox);

        CheckboxWidget crosshairCheckbox = CheckboxWidget.builder(Text.of("Hide crosshair while video playing"), client.textRenderer)
                ...
                .build();
        addDrawableChild(crosshairCheckbox);
