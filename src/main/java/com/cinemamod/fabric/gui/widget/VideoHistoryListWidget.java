...
public class VideoHistoryListWidget extends VideoListWidget {
    ...
    public VideoHistoryListWidget(VideoList videoList, MinecraftClient client, int width, int height, int bottom, int itemHeight) {
        super(videoList, client, width, height, bottom, itemHeight);
    }
